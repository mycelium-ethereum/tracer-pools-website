  ...
  return (
    ...
    >
      <div className="flex h-full w-full container mx-auto relative items-center lg:flex-row lg:pb-0 lg:justify-end justify-start xl:px-0 sm:pb-0 pb-96 flex-col px-4">
        <div
          className="force-flex lg:absolute xl:left-0 left-4 xl:mt-96 lg:mt-48 lg:justify-start lg:flex-row justify-center flex-col mx-auto z-10"
        ...
        <div className="w-2/5 integrate-animation 2xl:scale-75 absolute 2xl:-right-48 transform-gpu 2xl:top-0 xl:top-4 lg:scale-50 lg:-right-24 sm:scale-50 sm:-right-12 sm:-bottom-48 -right-10 -bottom-72">
