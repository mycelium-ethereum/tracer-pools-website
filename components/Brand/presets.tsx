...
const PrimaryStackedBlue = "/img/brand/primary-stacked/primary-stacked-blue.svg"
...
export const headings = {
    ...
    colours: {
        ...
        subheading: (
            <p>
                To ensure correct Tracer is represented correctly please ensure
                use of colors is consistent
            </p>
        ),
    },
    graphics: {
        ...
        subheading: (
            <p>
                Please use the support graphics when creating material for
                Tracer
            </p>
        ),
    },
    ...
    typography: {
        ...
        subheading: (
            <p>
                For consistency please ensure correct typography is being used
            </p>
        ),
    },
}

export const tags = ["Logos", "Colors", "Support Graphics", "Typography", "All"]
