...
export const articles = [
    ...
    },
    {
        ...
        description: "Introducing Tracer: peer-to-peer financial infrastructure for the decentralised economy.",
        tags: ["Whitepaper"],
    ...
    },
    {
        ...
        description: "Simulated reductions to volatility decay with Perpetual Pools V2",
        tags: ["Perpetual Pools"],
        link: "/radar/v2-simulations/",
    },
    {
        title: "Tracer Product Suite",
        description: "The factory, product and ecosystem levels of the Tracer suite.",
        tags: ["General"],
    ...
    },
    {
        ...
        description: "The full list of Tracer’s Perpetual Pools audits and C.A.R.E’s",
