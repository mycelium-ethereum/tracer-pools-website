    ...
    return (
        <div ref={containerRef}>
            <p className="mb-4">
                ...
                sets out how we collect, use, store and disclose your personal
                information.
            </p>
            <p className="mb-4">
                ...
                this Privacy Policy, do not access or use the services,
                websites, or any other aspect of our business.
            </p>
            <p className="mb-4">
                ...
                that apply between us. We may change our Privacy Policy from
                time to time by publishing changes to it on our website. We
                encourage you to check our website periodically to ensure that
            ...
            <h2 className="leading-[150%} mb-4 mt-8 text-xl font-bold text-highlight">
            ...
            <ul className="mb-4 list-outside list-disc pl-4">
                <li>
                    to enable you to access and use our website, services and
                    app;
                </li>

                <li>
                    to operate, protect, improve and optimise our website,
                    services and app, business and our users’ experience, such
                    as to perform analytics, conduct research and for
                ...
                <li>
                    ...
                    information sent by, or on behalf of, our business partners
            ...
            <p className="mb-4">
                ...
                including MetaMask. Unless expressly stated otherwise, we are
                not responsible for the privacy practices of integrated third
                party services, and have no control over or rights in those
                linked services. The privacy policies that apply to integrated
                third party services may differ substantially from our Privacy
            ...
            <p className="mb-4">
                ...
                contacting us at&nbsp;
                <a
                    className="text-tracer-lightblue"
                    href="mailto:hello@tracer.finance"
                >
                    hello@tracer.finance
                </a>
                . Sometimes, we may not be able to provide you with access to
                all of your personal information and, where this is the case, we
                will tell you why. We may also need to verify your identity when
                you request your personal information. If you think that any
                personal information we hold about you is inaccurate, please
                contact us and we will take reasonable steps to ensure that it
                is corrected.
            </p>
            <h2 className="leading-[150%} mb-4 mt-8 text-xl font-bold text-highlight">
                Contact Us
            ...
            <ul className="mb-4 list-outside list-disc pl-4">
                ...
                <li>
                    ...
                    transactions you make on our services, such as the type,
                    time or amount of a transaction;
                </li>
                <li>
                    correspondence, such as your feedback or questionnaire and
                    other survey responses;
                </li>
                <li>
                    online identifiers, such as your blockchain address, device
                    ID, device type, geo-location information, computer and
                ...
                <li>
                    usage data, such as user preferences and other data
                ...
                <li>
                    ...
                    to us directly through our website or app or indirectly
                    through your use of our website or app or online presence or
                    through other websites or accounts from which you permit us
            ...
            <p className="mb-4">
                ...
                service and products. This may take the form of emails, Discord
                messages, or other forms of communication, in accordance with
                the OECD Guidelines on the Protection of Privacy and Transborder
                Flows of Personal Data. You may opt-out of receiving marketing
                materials from us by contacting us using the details set out
                below or by using the opt-out facilities provided (eg an
                unsubscribe link).
            </p>
            <h2 className="leading-[150%} mb-4 mt-8 text-xl font-bold text-highlight">
            ...
            <p className="mb-4">
                ...
                the disclosure of your information globally which may include
                countries in the following jurisdictions: United States of
                America, British Virgin Islands, United Kingdom and Europe. We
                will, however, take reasonable steps to ensure that any overseas
                recipient will deal with such personal information in a way that
                is consistent with the OECD Guidelines on the Protection of
            ...
            <p className="mb-4">
                ...
                hard copy form. We take reasonable steps to protect your
                personal information from misuse, interference and loss, as well
                as unauthorised access, modification or disclosure and we use a
            ...
            <p className="mb-4">
                ...
                . Please include your name or Discord username and clearly
                describe your complaint. We will acknowledge your complaint and
                respond to you regarding your complaint within a reasonable
                period of time. If you think that we have failed to resolve the
                complaint satisfactorily, we will provide you with information
                about the further steps you can take.
            </p>
            <p className="mb-4">
                If you are not satisfied with our handling of a complaint or the
                outcome of a complaint, you may make an application to:
            </p>
            <ol className="list-inside list-alpha">
                ...
                <li>
                    contacting the Privacy Commissioner in your State or
                    Territory.
                </li>
            </ol>
            <h2 className="leading-[150%} mb-4 mt-8 text-xl font-bold text-highlight">
