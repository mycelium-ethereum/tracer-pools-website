  ...
  return (
    <div ref={containerRef}>
      <p className="mb-4">
        ...
        committed to respecting your privacy. Our Privacy Policy sets out how we
        collect, use, store and disclose your personal information.
      </p>
      <p className="mb-4">
        This Privacy Policy applies to our services, which include the services
        we provide on https://tracer.finance/ or any other websites, pages,
        features, or content we own or operate or when you use related services.
        If you do not agree with the terms of this Privacy Policy, do not access
        or use the services, websites, or any other aspect of our business.
      </p>
      <p className="mb-4">
      ...
      <ul className="mb-4 list-outside list-disc pl-4">
        ...
        <li>
          ...
          share information with us from other social applications, services or
          websites; or
        </li>
      ...
      <ul className="mb-4 list-outside list-disc pl-4">
        ...
        <li>
          to operate, protect, improve and optimise our website, services and
          app, business and our users’ experience, such as to perform analytics,
      ...
      <p className="mb-4">
        ...
        who also holds other information about you. This third party may combine
        that information in order to enable it and us to develop anonymised
        consumer insights so that we can better understand your preferences and
      ...
      <p className="mb-4">
        Various third party services are integrated with our website, including
        MetaMask. Unless expressly stated otherwise, we are not responsible for
        the privacy practices of integrated third party services, and have no
        control over or rights in those linked services. The privacy policies
        that apply to integrated third party services may differ substantially
        from our Privacy Policy, so we encourage individuals to read them before
      ...
      <p className="mb-4">
        ...
        your personal information and, where this is the case, we will tell you
        why. We may also need to verify your identity when you request your
        personal information. If you think that any personal information we hold
        about you is inaccurate, please contact us and we will take reasonable
      ...
      <ul className="mb-4 list-outside list-disc pl-4">
        ...
        <li>
          transactional information, such as information about the transactions
          you make on our services, such as the type, time or amount of a
          transaction;
        </li>
        <li>
        ...
        <li>
          online identifiers, such as your blockchain address, device ID, device
          type, geo-location information, computer and connection information,
        ...
        <li>
          ...
          accounts from which you permit us to collect information; or
        </li>
      ...
      <p className="mb-4">
        ...
        marketing communications and information about our service and products.
        This may take the form of emails, Discord messages, or other forms of
        communication, in accordance with the OECD Guidelines on the Protection
        of Privacy and Transborder Flows of Personal Data. You may opt-out of
      ...
      <p className="mb-4">
        ...
        personal information. However, we cannot guarantee the security of your
      ...
      <p className="mb-4">
        ...
        for the privacy practices of, or any content on, those linked websites,
        and have no control over or rights in those linked websites. The privacy
        policies that apply to those other websites may differ substantially
        from our Privacy Policy, so we encourage individuals to read them before
      ...
      <p className="mb-4">
        ...
        . Please include your name or Discord username and clearly describe your
