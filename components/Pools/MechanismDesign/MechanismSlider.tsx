...
const MechanismSlider: React.FC<{}> = () => {
  ...
  return (
    <div className="relative z-10 flex w-full items-center border border-action-active bg-white [box-shadow:_0px_4px_10px_2px_rgba(26,85,245,0.1)] xl:ml-12 xl:max-w-[767px] 3xl:max-w-[1477px]">
