...
const MechanismSlider: React.FC<{}> = () => {
  ...
  return (
    <div className="relative z-10 flex w-[calc(100%+48px)] -translate-x-6 flex-col border-t border-b border-action-active bg-white py-6 [box-shadow:_0px_4px_10px_2px_rgba(26,85,245,0.1)] sm:w-full sm:translate-x-0 sm:flex-row sm:items-center sm:border xl:ml-12 xl:max-w-[767px] 4xl:max-w-[1477px]">
      <SliderNav
        slider1={slider1}
        slider2={slider2}
      ...
      >
        {slideItems.map((item: { image: string; text: string }, i: number) => (
