...
const Indices: React.FC<{}> = () => {
    return (
        <header className="relative z-10 flex h-full max-w-[356px] flex-grow flex-col lg:max-w-[426px] lg:justify-center 3xl:max-w-full">
            ...
            <AnimateIn delayLevel={3}>
                <Paragraph className="max-w-[328px] 3xl:max-w-[420px]">
                    Transform any combination of data feeds into custom index
                    products or market neutral strategies which can be plugged
                    into any DeFi contract.
                </Paragraph>
            </AnimateIn>
