const Tokens: React.FC<{}> = () => {
  return (
    <div className="pointer-events-none absolute left-1/2 top-0 z-10 h-[600px] w-[500px] -translate-x-1/2 transform sm:left-auto sm:right-0 sm:mt-20 sm:w-[450px] sm:translate-x-0 md:top-1/2 md:mt-20 md:w-[700px] md:-translate-y-1/2 lg:-right-24 lg:w-full xl:h-[820px]">
      <img
