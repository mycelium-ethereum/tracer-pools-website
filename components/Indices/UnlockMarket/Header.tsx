const Header: React.FC<{}> = () => {
    return (
        <header className="mx-auto max-w-[579px] text-center 4xl:max-w-[830px]">
            <h1 className="mb-2 text-2xl leading-[30px] text-action-active sm:mb-4 sm:text-[40px] sm:leading-[48px] 4xl:text-[80px] 4xl:leading-[88px]">
                Unlock market
                <br className="block sm:hidden 4xl:block" /> access
            </h1>
